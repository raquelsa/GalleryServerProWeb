...
namespace GalleryServerPro.Business
{
	...
	/// </summary>
	public class VideoOptimizedCreator : IDisplayObjectCreator
	{
		...
		private bool IsOptimizedVideoRequired()
		{
			if (this._galleryObject.IsNew)
				...
				return (IsOptimizedVideoFileMissing() || this._galleryObject.RegenerateOptimizedOnSave);
		}

		private bool IsOptimizedVideoFileMissing()
		{
