...
namespace GalleryServerPro.Business
{
	...
	public class GpsLocation
	{
		...
		/// </returns>
		private static bool IsBelowSeaLevel(BitmapMetadata bmpMetadata)
		{
		...
		private static GpsDistance GetLatitude(BitmapMetadata bmpMetadata)
		{
		...
		/// <param name="bmpMetadata">An object containing the metadata.</param>
		/// <returns>An instance of <see cref="GpsDistance" />.</returns>
		private static GpsDistance GetLongitude(BitmapMetadata bmpMetadata)
		{
		...
		/// <param name="bmpMetadata">An object containing the metadata.</param>
		/// <returns>An instance of <see cref="GpsDistance" />.</returns>
		private static GpsDistance GetDestLatitude(BitmapMetadata bmpMetadata)
		{
		...
		/// <param name="bmpMetadata">An object containing the metadata.</param>
		/// <returns>An instance of <see cref="GpsDistance" />.</returns>
		private static GpsDistance GetDestLongitude(BitmapMetadata bmpMetadata)
		{
		...
		private static string GetVersion(BitmapMetadata bmpMetadata)
		{
			...
			return version.TrimEnd(new char[] { '.' });
		}
	...
	{
		readonly string[] _directionValues = new string[] { "N", "S", "W", "E" };
		readonly string[] _negativeDirectionValues = new string[] { "S", "W" };
		...
		{
			if (Array.IndexOf<string>(_directionValues, direction) >= 0)
			{
		...
		/// <summary>
		/// Performs an explicit conversion from <see cref="GalleryServerPro.Business.GpsDistance"/> to <see cref="System.Double"/>.
		/// </summary>
		...
		{
			double distance = (double)Degrees + ((double)Minutes) / 60.0d + ((double)Seconds) / 3600.0d;

			if (Array.IndexOf<string>(_negativeDirectionValues, Direction) >= 0)
			{
				distance = distance * -1;
			}
