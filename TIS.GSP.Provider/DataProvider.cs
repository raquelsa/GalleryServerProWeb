...
namespace GalleryServerPro.Provider
{
	...
	/// </summary>
	public abstract class DataProvider : System.Configuration.Provider.ProviderBase, Interfaces.IDataProvider
	{
		...
		public new abstract ProviderDataStore DataStore { get; }
		...
		/// </returns>
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1707:IdentifiersShouldNotContainUnderscores", MessageId = "Member")]
		public abstract IEnumerable<GallerySettingDto> GallerySetting_GetGallerySettings();
		...
		/// </returns>
		public abstract IEnumerable<GalleryControlSettingDto> GalleryControlSetting_GetGalleryControlSettings();
		...
		/// </returns>
		public abstract IEnumerable<int> Album_GetChildAlbumIdsById(int albumId);
		...
		/// </returns>
		public abstract IEnumerable<MediaObjectDto> Album_GetChildMediaObjectsById(int albumId, bool includeMetadata);
		...
		/// </returns>
		public abstract AlbumDto Album_GetAlbumById(int albumId);
		...
		public abstract MediaObjectDto MediaObject_GetMediaObjectById(int mediaObjectId, bool includeMetadata);
		...
		/// </returns>
		public abstract IEnumerable<MediaObjectMetadataDto> MediaObject_GetMetadataItemsByMediaObjectId(int mediaObjectId);
		...
		/// </returns>
		public abstract System.Collections.Specialized.StringCollection MediaObject_GetAllHashKeys();

		#endregion

		#region Media Queue Methods
		...
		public abstract IEnumerable<MediaQueueDto> MediaQueue_GetMediaQueues();
		...
		public abstract ISynchronizationStatus Synchronize_RetrieveStatus(int galleryId, IFactory factory);
		...
		/// </returns>
		public abstract IEnumerable<AppSettingDto> AppSetting_GetAppSettings();
		...
		public abstract void SearchGallery(int galleryId, string[] searchTerms, out List<int> matchingAlbumIds, out List<int> matchingMediaObjectIds);
		...
		public abstract void ImportGalleryData(string galleryData, bool importMembershipData, bool importGalleryData);
		...
		/// </returns>
		public abstract string ExportGalleryData(bool exportMembershipData, bool exportGalleryData);
		...
		/// </returns>
		public abstract IEnumerable<RoleDto> Roles_GetRoles();
		...
		/// </returns>
		public abstract IEnumerable<AppErrorDto> AppError_GetAppErrors();
		...
		/// </summary>
		/// <param name="galleryId">The gallery ID.</param>
		public abstract void AppError_ClearLog(int galleryId);
		...
		/// </returns>
		public abstract IEnumerable<MimeTypeDto> MimeType_GetMimeTypes();
		...
		/// </returns>
		public abstract IEnumerable<MimeTypeGalleryDto> MimeType_GetMimeTypeGalleries();
		...
		/// same object in memory as the <paramref name="emptyCollection"/> parameter.
		/// </returns>
		public abstract IBrowserTemplateCollection MimeType_GetBrowserTemplates(IBrowserTemplateCollection emptyCollection);
		...
		/// </returns>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="factory" /> is null.</exception>
		public abstract IUserProfile Profile_GetUserProfile(string userName, IFactory factory);
		...
		public abstract void Profile_Save(IUserProfile profile);

		/// <summary>
		/// Permanently delete the profile records for the specified <paramref name="userName"/>.
		/// </summary>
		/// <param name="userName">The user name that uniquely identifies the user.</param>
		public abstract void Profile_DeleteProfileForUser(string userName);

		/// <summary>
		/// Permanently delete the profile records associated with the specified <paramref name="galleryId"/>.
		/// </summary>
		/// <param name="galleryId">The gallery ID.</param>
		public abstract void Profile_DeleteProfilesForGallery(int galleryId);
